...
import iestr.jmff.gestorfacturas.controlador.ClienteJpaController;
import iestr.jmff.gestorfacturas.controlador.FacturaJpaController;
...
public class Menu extends javax.swing.JFrame {
    ...
    private void mitAnadirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mitAnadirActionPerformed
        ...
        nueva.setCliente(cjc.findCliente(Integer.valueOf(cmbCliente.getSelectedItem().toString().substring(0,1))));
        nueva.setBaja(0);
